...
:::warning
<span style="color: #D83931">您可以通过我们的</span><span style="color: #D83931">官网</span><span style="color: #D83931">体验中心在线试听各音色的具体效果。</span>
官网体验中心：[https://www.volcengine.com/product/tts](https://www.volcengine.com/product/tts)
:::
<span id="在线音色列表"></span>
# 在线音色列表
注：
...
<span id="96330195"></span>
### <span style="background-color: rgba(183,237,177, 0.8)"><strong>情感参数（emotion）：</strong></span>
括号内为对应的情感参数：
...
|---|---|---|---|---|---|---|
| | | | | | | | \
|通用场景  |Vivi 2.0 |zh_female_vv_uranus_bigtts |中文、英语 | | |否 |
| | | | | | | | \
|通用场景 |小何 2.0 |zh_female_xiaohe_uranus_bigtts |中文 | | |否 |
| | | | | | | | \
|通用场景 |云舟 2.0 |zh_male_m191_uranus_bigtts |中文 | | |否 |
| | | | | | | | \
|通用场景 |小天 2.0 |zh_male_taocheng_uranus_bigtts |中文 | | |否 |

<span id="70767f76"></span>
### <span style="background-color: rgba(183,237,177, 0.8)"><strong>精品音色列表</strong></span>

| | | | | | | | \
|**场景** |**音色名称** |**voice_type** |**语种** |**支持的情感** |**上线业务方** |**是否支持MIX** |
|---|---|---|---|---|---|---|
| | | | | | | | \
|有声阅读 |儿童绘本 |zh_female_xueayi_saturn_bigtts |中文 | |剪映 |否 |
| | | | | | | | \
|视频配音 |大壹 |zh_male_dayi_saturn_bigtts |中文 | |剪映 |否 |
| | | | | | | | \
|视频配音 |黑猫侦探社咪 |zh_female_mizai_saturn_bigtts |中文 | |剪映 |否 |
| | | | | | | | \
|视频配音 |鸡汤女 |zh_female_jitangnv_saturn_bigtts |中文 | |剪映 |否 |
| | | | | | | | \
|视频配音 |魅力女友 |zh_female_meilinvyou_saturn_bigtts |中文 | |剪映 |否 |
| | | | | | | | \
|视频配音 |流畅女声 |zh_female_santongyongns_saturn_bigtts |中文 | |剪映 |否 |
| | | | | | | | \
|视频配音 |儒雅逸辰 |zh_male_ruyayichen_saturn_bigtts |中文 | |剪映 |否 |
| | | | | | | | \
|角2.0色扮演 |可爱女生 |saturn_zh_female_keainvsheng_tob |中文 | | |否 |
| | | | | | | | \
|角色扮演 |调皮公主 |saturn_zh_female_tiaopigongzhu_tob |中文 | | |否 |
| | | | | | | | \
|角色扮演 |爽朗少年 |saturn_zh_male_shuanglangshaonian_tob |中文 | | |否 |
| | | | | | | | \
|角色扮演 |天才同桌 |saturn_zh_male_tiancaitongzhuo_tob |中文 | | |否 |
| | | | | | | | \
|角色扮演 |知性灿灿 |saturn_zh_female_cancan_tob |中文 | | |否 |
